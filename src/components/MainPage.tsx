          ...
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center space-y-4 text-center">
              ...
              <div className="space-x-4">
                <Button className="bg-white text-black hover:bg-gray-200">Solicitar Presupuesto</Button>
          ...
          <div className="container px-4 md:px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="flex flex-col items-center text-center">
                <Wrench className="h-12 w-12 mb-4 text-blue-600" />
            ...
            <div className="flex flex-col items-center space-y-4 text-center">
              ...
              <div className="w-full max-w-sm space-y-2">
                <form className="flex space-x-2">
                  <Input className="max-w-lg flex-1 bg-white text-black" placeholder="Ingrese su correo" type="email" />
